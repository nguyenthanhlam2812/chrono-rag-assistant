...
[Connect these docs](/use-these-docs) to Claude, VSCode, and more via MCP for real-time answers.[Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/langgraph/workflows-agents.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
Was this page helpful?
YesNo[Thinking in LangGraphPrevious](/oss/python/langgraph/thinking-in-langgraph)[PersistenceNext](/oss/python/langgraph/persistence)⌘ I